...
public class Chapter2Test {
    ...
    @Test
    public void requestUsZipCode90210_checkLongitudeInResponseBody_expectValue() {
    ...
    //issue here, have to check later
    @Test
    public void requestUsZipCode90210_checkStateAbbreviationInResponseBody_expectCA() {
    ...
    @Test
    public void requestUsZipCode90210_checkLatitudeInResponseBody_expectValue() {
    ...
    @Test
    public void requestUsZipCode90210_checkInvertsLatitudeInResponseBody_expectValue() {
        ...
        given().
                ...
                then().
                assertThat().
                body("places[0].latitude", not(equalTo("34.1901")));
    }
